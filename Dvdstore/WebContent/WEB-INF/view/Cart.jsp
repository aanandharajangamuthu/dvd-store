...
<body>
    <center>
        <br><br><br>
            <p style="color:white"><c:out value="${amt}"/></p>
        <br><br><br>
...
<td><input type="hidden" id="id" name="id" value="${cart.id}"/></td>
...
<a href="purchase.html"><input type="button" class="button" value="PurchaseOrder"></a><br>
</c:if>
<br>
</center>
</body>
